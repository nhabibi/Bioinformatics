...
NUMBER_OF_FEATURES = 419; %529 - 110;  
...
NNLayerSize = 500;
    ...
    for n=1:1:numberOfTrainFiles
        ...
        %trainSelectedPairsFile = load( strcat(TOP_4L_PAIRS_PATH,trainFileNames{n,1},'.mat') );
    ...
    for t=1:1:numberOfTestFiles
        ...
        %testSelectedPairsFile = load( strcat(NN_DATA_PATH,testFileNames{t,1},'.mat') );

%function [ geneSeqFeatures ] = Generate_Gene_Seq_Features_ChanHirose()
%--------------------------------------------------------------------------   
 clc
 clear all
...
%--------------------------------------------------------------------------   
features_Chan = Generate_Gene_Seq_Features_Chan();

gene_1Mer_s   = features_Chan(:,1:4);
gene_2Mer_s   = features_Chan(:,5:20);
gene_3Mer_s   = features_Chan(:,21:84);
gene_length_s = features_Chan(:,85);
GC_content_s  = features_Chan(:,86);
CAI_s         = features_Chan(:,87);
